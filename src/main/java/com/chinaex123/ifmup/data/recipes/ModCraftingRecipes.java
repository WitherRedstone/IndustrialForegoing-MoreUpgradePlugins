...
public class ModCraftingRecipes {
    ...
    public void buildCraftingRecipes(@NotNull RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.SHADOW_BLOCK.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.INGOT_SHADOW)
                .unlockedBy("has_shadow_ingot", has(ModItemTags.INGOT_SHADOW))
                .save(recipeOutput);
        // 暗影锭
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW.INGOT.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.NUGGET_SHADOW)
                .unlockedBy("has_shadow_nugget", has(ModItemTags.NUGGET_SHADOW))
                .save(recipeOutput);
        // 暗影棍
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW.ROD.get())
                ...
                .pattern("   ")
                .define('A', ModItemTags.INGOT_SHADOW)
                .unlockedBy("has_shadow_ingot_rod", has(ModItemTags.INGOT_SHADOW))
                .save(recipeOutput);
        // 暗影齿轮
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW.GEAR.get())
                ...
                .pattern(" A ")
                .define('A', ModItemTags.INGOT_SHADOW)
                .unlockedBy("has_shadow_ingot_gear", has(ModItemTags.GEAR_SHADOW))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.SHADOW_ROSE_BLOCK.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.INGOT_SHADOW_ROSE)
                .unlockedBy("has_shadow_rose_ingot", has(ModItemTags.INGOT_SHADOW_ROSE))
                .save(recipeOutput);
        // 暗影玫瑰锭
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW_ROSE.INGOT.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.NUGGET_SHADOW_ROSE)
                .unlockedBy("has_shadow_rose_nugget", has(ModItemTags.NUGGET_SHADOW_ROSE))
                .save(recipeOutput);
        // 暗影玫瑰棍
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW_ROSE.ROD.get())
                ...
                .pattern("   ")
                .define('A', ModItemTags.INGOT_SHADOW_ROSE)
                .unlockedBy("has_shadow_rose_ingot_rod", has(ModItemTags.INGOT_SHADOW_ROSE))
                .save(recipeOutput);
        // 暗影玫瑰齿轮
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SHADOW_ROSE.GEAR.get())
                ...
                .pattern(" A ")
                .define('A', ModItemTags.INGOT_SHADOW_ROSE)
                .unlockedBy("has_shadow_rose_ingot_gear", has(ModItemTags.GEAR_SHADOW_ROSE))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.UNKNOWN_MAGIC_BLOCK.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.INGOT_UNKNOWN_MAGIC)
                .unlockedBy("has_unknown_magic_ingot", has(ModItemTags.INGOT_UNKNOWN_MAGIC))
                .save(recipeOutput);
        // 未知魔法锭
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.UNKNOWN_MAGIC.INGOT.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.NUGGET_UNKNOWN_MAGIC)
                .unlockedBy("has_unknown_magic_nugget", has(ModItemTags.NUGGET_UNKNOWN_MAGIC))
                .save(recipeOutput);
        // 未知魔法棍
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.UNKNOWN_MAGIC.ROD.get())
                ...
                .pattern("   ")
                .define('A', ModItemTags.INGOT_UNKNOWN_MAGIC)
                .unlockedBy("has_unknown_magic_ingot_rod", has(ModItemTags.INGOT_UNKNOWN_MAGIC))
                .save(recipeOutput);
        // 未知魔法齿轮
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.UNKNOWN_MAGIC.GEAR.get())
                ...
                .pattern(" A ")
                .define('A', ModItemTags.INGOT_UNKNOWN_MAGIC)
                .unlockedBy("has_unknown_magic_ingot_gear", has(ModItemTags.GEAR_UNKNOWN_MAGIC))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.STAR_ETHER_ALLOY_BLOCK.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.INGOT_STAR_ETHER_ALLOY)
                .unlockedBy("has_star_ether_alloy_ingot", has(ModItemTags.INGOT_STAR_ETHER_ALLOY))
                .save(recipeOutput);
        // 星以合金锭
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.STAR_ETHER_ALLOY.INGOT.get())
                ...
                .pattern("AAA")
                .pattern("AAA")
                .define('A', ModItemTags.NUGGET_STAR_ETHER_ALLOY)
                .unlockedBy("has_star_ether_alloy_nugget", has(ModItemTags.NUGGET_STAR_ETHER_ALLOY))
                .save(recipeOutput);
        // 星以合金棍
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.STAR_ETHER_ALLOY.ROD.get())
                ...
                .pattern("   ")
                .define('A', ModItemTags.INGOT_STAR_ETHER_ALLOY)
                .unlockedBy("has_star_ether_alloy_ingot_rod", has(ModItemTags.INGOT_STAR_ETHER_ALLOY))
                .save(recipeOutput);
        // 星以合金齿轮
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.STAR_ETHER_ALLOY.GEAR.get())
                ...
                .pattern(" A ")
                .define('A', ModItemTags.INGOT_STAR_ETHER_ALLOY)
                .unlockedBy("has_star_ether_alloy_ingot_gear", has(ModItemTags.GEAR_STAR_ETHER_ALLOY))
                .save(recipeOutput);

        // -------------------- 暗影 - 工具装备 --------------------
        armorAndToolsRecipes(recipeOutput, ModItemTags.INGOT_SHADOW, ModItemTags.ROD_SHADOW,
        ...
        // -------------------- 未知魔法 - 工具装备 --------------------
        armorAndToolsRecipes(recipeOutput, ModItemTags.INGOT_UNKNOWN_MAGIC, ModItemTags.ROD_UNKNOWN_MAGIC,
        ...
        // -------------------- 暗影玫瑰 - 工具装备 --------------------
        armorAndToolsRecipes(recipeOutput, ModItemTags.INGOT_SHADOW_ROSE, ModItemTags.ROD_SHADOW_ROSE,
        ...
        // -------------------- 星以合金 - 工具装备 --------------------
        armorAndToolsRecipes(recipeOutput, ModItemTags.INGOT_STAR_ETHER_ALLOY, ModItemTags.ROD_STAR_ETHER_ALLOY,
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SHADOW.NUGGET.get(),9)
                .requires(ModItemTags.INGOT_SHADOW)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SHADOW.RAW.get(),9)
                ...
                .unlockedBy("has_raw_shadow_9", has(ModItemTags.INGOT_SHADOW))
                .save(recipeOutput);
        // 暗影玫瑰粒
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SHADOW_ROSE.NUGGET.get(),9)
                .requires(ModItemTags.INGOT_SHADOW_ROSE)
                .unlockedBy("has_shadow_rose_ingot_9", has(ModItemTags.INGOT_SHADOW_ROSE))
                .save(recipeOutput);
        // 未知魔法粒
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.UNKNOWN_MAGIC.NUGGET.get(),9)
                .requires(ModItemTags.INGOT_UNKNOWN_MAGIC)
                .unlockedBy("has_unknown_magic_ingot_9", has(ModItemTags.INGOT_UNKNOWN_MAGIC))
                .save(recipeOutput);
        // 星以合金粒
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.STAR_ETHER_ALLOY.NUGGET.get(),9)
                .requires(ModItemTags.INGOT_STAR_ETHER_ALLOY)
                .unlockedBy("has_star_ether_alloy_ingot_9", has(ModItemTags.INGOT_STAR_ETHER_ALLOY))
                .save(recipeOutput);
    }
