...
public class IFMUPArmorMaterials {
    ...
    }), 8, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.5F, 0.0F, () -> Ingredient.of(IFMUPItemTags.INGOTS_SHADOW));
    // 未知魔法
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.05F, () -> Ingredient.of(IFMUPItemTags.INGOTS_UNKNOWN_MAGIC));
    // 暗影玫瑰
    ...
    }), 22, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.15F, () -> Ingredient.of(IFMUPItemTags.INGOTS_SHADOW_ROSE));
    // 星以合金
    ...
    }), 30, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.25F, () -> Ingredient.of(IFMUPItemTags.INGOTS_STAR_ETHER_ALLOY));
