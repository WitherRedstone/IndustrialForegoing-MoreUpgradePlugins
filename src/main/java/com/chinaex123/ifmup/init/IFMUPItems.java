...
public class IFMUPItems {
    ...
    public static final DeferredItem<Item> DARKSHINE_BUCKET = ITEMS_REGISTER.register("darkshine_bucket", () ->
            new BucketItem(IFMUPFluids.DARKSHINE.get(), new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET))); // 黯曜桶
    ...
    public static final DeferredItem<Item> SHADOW_SWORD = ITEMS_REGISTER.register("shadow_sword", () ->
            new SwordItem(IFMUPToolTiers.SHADOW, new Item.Properties().attributes(SwordItem.createAttributes(IFMUPToolTiers.SHADOW, 3.0f, -2.4f)).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> SHADOW_PICKAXE = ITEMS_REGISTER.register("shadow_pickaxe", () ->
            new PickaxeItem(IFMUPToolTiers.SHADOW, new Item.Properties().attributes(PickaxeItem.createAttributes(IFMUPToolTiers.SHADOW, 1.0f, -2.4f)).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> SHADOW_AXE = ITEMS_REGISTER.register("shadow_axe", () ->
            new AxeItem(IFMUPToolTiers.SHADOW, new Item.Properties().attributes(AxeItem.createAttributes(IFMUPToolTiers.SHADOW, 5.0f, -3.0f)).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> SHADOW_SHOVEL = ITEMS_REGISTER.register("shadow_shovel", () ->
            new ShovelItem(IFMUPToolTiers.SHADOW, new Item.Properties().attributes(ShovelItem.createAttributes(IFMUPToolTiers.SHADOW, 1.5f, -3.0f)).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> SHADOW_HOE = ITEMS_REGISTER.register("shadow_hoe", () ->
            new HoeItem(IFMUPToolTiers.SHADOW, new Item.Properties().attributes(HoeItem.createAttributes(IFMUPToolTiers.SHADOW, -2.0f, 0f)).rarity(Rarity.UNCOMMON)));
    // -------------------- 暗影 护甲 --------------------
    public static final DeferredItem<Item> SHADOW_HELMET = ITEMS_REGISTER.register("shadow_helmet", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(20))));
    public static final DeferredItem<Item> SHADOW_CHESTPLATE = ITEMS_REGISTER.register("shadow_chestplate", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(20))));
    public static final DeferredItem<Item> SHADOW_LEGGINGS = ITEMS_REGISTER.register("shadow_leggings", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(20))));
    public static final DeferredItem<Item> SHADOW_BOOTS = ITEMS_REGISTER.register("shadow_boots", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(20))));
    ...
    public static final DeferredItem<Item> UNKNOWN_MAGIC_SWORD = ITEMS_REGISTER.register("unknown_magic_sword", () ->
            new SwordItem(IFMUPToolTiers.UNKNOWN_MAGIC, new Item.Properties().attributes(SwordItem.createAttributes(IFMUPToolTiers.UNKNOWN_MAGIC, 4.0f, -2.4f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_PICKAXE = ITEMS_REGISTER.register("unknown_magic_pickaxe", () ->
            new PickaxeItem(IFMUPToolTiers.UNKNOWN_MAGIC, new Item.Properties().attributes(PickaxeItem.createAttributes(IFMUPToolTiers.UNKNOWN_MAGIC, 5.0f, -2.4f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_AXE = ITEMS_REGISTER.register("unknown_magic_axe", () ->
            new AxeItem(IFMUPToolTiers.UNKNOWN_MAGIC, new Item.Properties().attributes(AxeItem.createAttributes(IFMUPToolTiers.UNKNOWN_MAGIC, 6.0f, -3.0f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_SHOVEL = ITEMS_REGISTER.register("unknown_magic_shovel", () ->
            new ShovelItem(IFMUPToolTiers.UNKNOWN_MAGIC, new Item.Properties().attributes(ShovelItem.createAttributes(IFMUPToolTiers.UNKNOWN_MAGIC, 0f, -3.0f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_HOE = ITEMS_REGISTER.register("unknown_magic_hoe", () ->
            new HoeItem(IFMUPToolTiers.UNKNOWN_MAGIC, new Item.Properties().attributes(HoeItem.createAttributes(IFMUPToolTiers.UNKNOWN_MAGIC, -1.0f, 0f)).rarity(Rarity.EPIC)));
    // -------------------- 未知魔法 护甲 --------------------
    public static final DeferredItem<Item> UNKNOWN_MAGIC_HELMET = ITEMS_REGISTER.register("unknown_magic_helmet", () ->
            new ArmorItem(IFMUPArmorMaterials.UNKNOWN_MAGIC, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(40))));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_CHESTPLATE = ITEMS_REGISTER.register("unknown_magic_chestplate", () ->
            new ArmorItem(IFMUPArmorMaterials.UNKNOWN_MAGIC, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(40))));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_LEGGINGS = ITEMS_REGISTER.register("unknown_magic_leggings", () ->
            new ArmorItem(IFMUPArmorMaterials.UNKNOWN_MAGIC, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(40))));
    public static final DeferredItem<Item> UNKNOWN_MAGIC_BOOTS = ITEMS_REGISTER.register("unknown_magic_boots", () ->
            new ArmorItem(IFMUPArmorMaterials.UNKNOWN_MAGIC, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(40))));
    ...
    public static final DeferredItem<Item> SHADOW_ROSE_SWORD = ITEMS_REGISTER.register("shadow_rose_sword", () ->
            new SwordItem(IFMUPToolTiers.SHADOW_ROSE, new Item.Properties().attributes(SwordItem.createAttributes(IFMUPToolTiers.SHADOW_ROSE, 6.0f, -2.4f)).rarity(Rarity.RARE)));
    public static final DeferredItem<Item> SHADOW_ROSE_PICKAXE = ITEMS_REGISTER.register("shadow_rose_pickaxe", () ->
            new PickaxeItem(IFMUPToolTiers.SHADOW_ROSE, new Item.Properties().attributes(PickaxeItem.createAttributes(IFMUPToolTiers.SHADOW_ROSE, 4.0f, -2.4f)).rarity(Rarity.RARE)));
    public static final DeferredItem<Item> SHADOW_ROSE_AXE = ITEMS_REGISTER.register("shadow_rose_axe", () ->
            new AxeItem(IFMUPToolTiers.SHADOW_ROSE, new Item.Properties().attributes(AxeItem.createAttributes(IFMUPToolTiers.SHADOW_ROSE, 8.0f, -3.0f)).rarity(Rarity.RARE)));
    public static final DeferredItem<Item> SHADOW_ROSE_SHOVEL = ITEMS_REGISTER.register("shadow_rose_shovel", () ->
            new ShovelItem(IFMUPToolTiers.SHADOW_ROSE, new Item.Properties().attributes(ShovelItem.createAttributes(IFMUPToolTiers.SHADOW_ROSE, 1.5f, -3.0f)).rarity(Rarity.RARE)));
    public static final DeferredItem<Item> SHADOW_ROSE_HOE = ITEMS_REGISTER.register("shadow_rose_hoe", () ->
            new HoeItem(IFMUPToolTiers.SHADOW_ROSE, new Item.Properties().attributes(HoeItem.createAttributes(IFMUPToolTiers.SHADOW_ROSE, 1.0f, 0f)).rarity(Rarity.RARE)));
    // -------------------- 暗影玫瑰 护甲 --------------------
    public static final DeferredItem<Item> SHADOW_ROSE_HELMET = ITEMS_REGISTER.register("shadow_rose_helmet", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW_ROSE, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(60))));
    public static final DeferredItem<Item> SHADOW_ROSE_CHESTPLATE = ITEMS_REGISTER.register("shadow_rose_chestplate", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW_ROSE, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(60))));
    public static final DeferredItem<Item> SHADOW_ROSE_LEGGINGS = ITEMS_REGISTER.register("shadow_rose_leggings", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW_ROSE, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(60))));
    public static final DeferredItem<Item> SHADOW_ROSE_BOOTS = ITEMS_REGISTER.register("shadow_rose_boots", () ->
            new ArmorItem(IFMUPArmorMaterials.SHADOW_ROSE, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(60))));
    ...
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_SWORD = ITEMS_REGISTER.register("star_ether_alloy_sword", () -> 
            new SwordItem(IFMUPToolTiers.STAR_ETHER_ALLOY, new Item.Properties().attributes(SwordItem.createAttributes(IFMUPToolTiers.STAR_ETHER_ALLOY, 10.0f, -2.2f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_PICKAXE = ITEMS_REGISTER.register("star_ether_alloy_pickaxe", () -> 
            new PickaxeItem(IFMUPToolTiers.STAR_ETHER_ALLOY, new Item.Properties().attributes(PickaxeItem.createAttributes(IFMUPToolTiers.STAR_ETHER_ALLOY, 8.0f, -2.2f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_AXE = ITEMS_REGISTER.register("star_ether_alloy_axe", () ->
            new AxeItem(IFMUPToolTiers.STAR_ETHER_ALLOY, new Item.Properties().attributes(AxeItem.createAttributes(IFMUPToolTiers.STAR_ETHER_ALLOY, 12.0f, -2.8f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_SHOVEL = ITEMS_REGISTER.register("star_ether_alloy_shovel", () ->
            new ShovelItem(IFMUPToolTiers.STAR_ETHER_ALLOY, new Item.Properties().attributes(ShovelItem.createAttributes(IFMUPToolTiers.STAR_ETHER_ALLOY, 4.5f, -2.8f)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_HOE = ITEMS_REGISTER.register("star_ether_alloy_hoe", () -> 
            new HoeItem(IFMUPToolTiers.STAR_ETHER_ALLOY, new Item.Properties().attributes(HoeItem.createAttributes(IFMUPToolTiers.STAR_ETHER_ALLOY, 4.0f, 0f)).rarity(Rarity.EPIC)));
    // -------------------- 星以合金 护甲 --------------------
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_HELMET = ITEMS_REGISTER.register("star_ether_alloy_helmet", () ->
            new ArmorItem(IFMUPArmorMaterials.STAR_ETHER_ALLOY, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(120))));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_CHESTPLATE = ITEMS_REGISTER.register("star_ether_alloy_chestplate", () ->
            new ArmorItem(IFMUPArmorMaterials.STAR_ETHER_ALLOY, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(120))));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_LEGGINGS = ITEMS_REGISTER.register("star_ether_alloy_leggings", () ->
            new ArmorItem(IFMUPArmorMaterials.STAR_ETHER_ALLOY, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(120))));
    public static final DeferredItem<Item> STAR_ETHER_ALLOY_BOOTS = ITEMS_REGISTER.register("star_ether_alloy_boots", () ->
            new ArmorItem(IFMUPArmorMaterials.STAR_ETHER_ALLOY, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(120))));
